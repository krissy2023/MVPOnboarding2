...
import SaleCreateUpdateRecordModal from "../components/SaleCreateUpdateRecordModal.jsx";
...
function Sale() {
  ...
  const columns = ["customerName", "productName", "storeName", "formattedDate"];
  const pageSize = pagesize;
  const pageNumber = pagenumber;
  const totalPages = totalDataCount / pageSize;
  const url = API_ENDPOINTS.SALE;
